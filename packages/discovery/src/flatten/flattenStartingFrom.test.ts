...
describe(flattenStartingFrom.name, () => {
  ...
  const LIBRARY_SOURCE = 'library Contract2\r\n{\r\n function lf() public {}\r\n }'
  const BASE_SOURCE = 'contract Contract3\r\n{\r\n function bcf() public {}\r\n }'
  const ROOT_SOURCE =
    'contract Contract1 is Contract3\r\n {\r\n function cf() public {\r\n Contract2.lf(); this.bcf();\r\n }\r\n }'
  const ROOT_FILE_SOURCE = `${LIBRARY_SOURCE}${BASE_SOURCE}${ROOT_SOURCE}`

  const LIBRARY_SOURCE_UNIX = 'library Contract2\n{\n function lf() public {}\n }'
  const BASE_SOURCE_UNIX = 'contract Contract3\n{\n function bcf() public {}\n }'
